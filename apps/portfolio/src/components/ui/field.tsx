...
function FieldLabel({
  ...
  return (
    <Label
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 px-0.5 font-semibold text-base text-foreground leading-snug group-data-[disabled=true]/field:opacity-50",
