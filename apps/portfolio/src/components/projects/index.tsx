    ...
    <div className="flex flex-col justify-center gap-12 py-12">
      <div className="flex flex-col gap-4">
        <div className="mx-auto flex flex-col items-center justify-center gap-4 text-center font-formula uppercase tracking-wider">
          ...
          <div className="group flex flex-row items-start text-[#FFCCDD] tracking-wide">
      ...
      <div className="mx-auto flex w-full max-w-screen-xl flex-col items-center gap-12 border px-8 py-12 lg:flex-row lg:gap-4"></div>
    </div>
  );
};
